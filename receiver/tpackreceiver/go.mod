module github.com/ProjectASAP/TPack/receiver/tpackreceiver

go 1.25.0

require (
	github.com/ProjectASAP/TPack/pkg/tpackmodel v0.0.0
...
replace github.com/ProjectASAP/TPack/pkg/tpackmodel => ../../pkg/tpackmodel
