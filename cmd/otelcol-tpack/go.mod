module github.com/ProjectASAP/TPack/cmd/otelcol-tpack

go 1.25.0

require (
	github.com/ProjectASAP/TPack/exporter/tpackexporter v0.0.0
	github.com/ProjectASAP/TPack/receiver/tpackreceiver v0.0.0
...
require (
	github.com/ProjectASAP/TPack/pkg/tpackmodel v0.0.0 // indirect
...
replace (
	github.com/ProjectASAP/TPack/exporter/tpackexporter => ../../exporter/tpackexporter
	github.com/ProjectASAP/TPack/pkg/tpackmodel => ../../pkg/tpackmodel
	github.com/ProjectASAP/TPack/receiver/tpackreceiver => ../../receiver/tpackreceiver
)
