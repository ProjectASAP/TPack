...
def extract_rate_data_by_filter(report_data, experiments, filter_level, min_count=0):
    """
...
def plot_rate_scatter(data_points, metric, filter_level, output_dir):
    ...
    title = build_filter_title("Rate Over Time", metric, filter_level)
    ...
    filename = f"rate_over_time_{filter_suffix}_{metric_short}.png"
...
def generate_all_rate_plots(report_path, output_dir="./plots", cost_config=None, min_count=100):
    """
    ...
    for filter_level in range(3):
        ...
        plot_rate_scatter(data_points, "mape_fidelity", filter_level, output_dir)
